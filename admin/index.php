...
<style>
    :root {
        --primary-gradient: linear-gradient(135deg, #667eea 0%, #764ba2 100%); /* Previous primary */
        --secondary-gradient: linear-gradient(135deg, #e0f2f7 0%, #b2ebf2 100%); /* Previous secondary */
        --blue-indigo-gradient: linear-gradient(135deg, #3f51b5 0%, #673ab7 100%); /* New primary */
        --light-blue-gradient: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%); /* New secondary */
    ...
    .main {
        ...
        background: var(--blue-indigo-gradient);
        position: relative;
        overflow: hidden;
    }
    ...
    .btn-login:hover {
        ...
        color: #3f51b5; /* Indigo text on hover */
