                    ...
                    <div class="flex items-center space-x-4 relative">
                        ...
                        <div class="relative mr-2">
                            ...
                            <div id="profile-dropdown" class="hidden absolute right-0 mt-2 w-40 bg-white rounded-md shadow-lg z-50">
                                <a href="profile.php" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">  <i class="fas fa-user"></i> Profile </a>
                                <a href="settings.php" class="block px-4 py-2 text-gray-700 hover:bg-gray-100"> <i class="fas fa-gear"></i> Settings</a>
                                <a href="logout.php" class="block px-4 py-2 text-gray-700 hover:bg-gray-100"> <i class="fas fa-sign-out"></i> Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
